...
export async function sendWhatsAppMessage(
    to: string,
    templateName: string,
    components: any, // Keeping it loose to support Msg91's specific varied strictures
    namespace: string = process.env.MSG91_NAMESPACE || "de03d239_9cbd_4348_ad12_4d8a4ea70188"
) {
