            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 lg:px-24 py-12 bg-white">
                <div className="w-full max-w-md mx-auto">
                    ...
                    <div className="bg-gray-100 p-1 rounded-xl mb-8 flex relative">
                        <div className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-white rounded-lg shadow-sm transition-all duration-300 ease-out ${isMagicLink ? 'left-[calc(50%+2px)]' : 'left-1'}`}></div>
                        <button
                            type="button"
                            onClick={() => setIsMagicLink(false)}
                            className={`flex-1 relative z-10 py-2.5 text-sm font-semibold transition-colors ${!isMagicLink ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700'}`}
                        >
                            Password
                        </button>
                        <button
                            ...
                            className={`flex-1 relative z-10 py-2.5 text-sm font-semibold transition-colors flex items-center justify-center gap-2 ${isMagicLink ? 'text-gray-900' : 'text-gray-500 hover:text-gray-700'}`}
                        >
