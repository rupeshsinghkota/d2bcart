...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
    try {
        ...
        return {
            title: 'D2BCart | Wholesale Marketplace',
            description: 'Browse wholesale products directly from manufacturers.',
        }
    }
}
    ...
    try {
        ...
        return (
            <div className="p-10 text-center">
                ...
                <code className="block mt-4 bg-gray-100 p-4 text-left whitespace-pre-wrap text-xs font-mono">
